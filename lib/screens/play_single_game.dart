...
class _PlaySingleGameState extends State<PlaySingleGame> {
  ...
  submitGameData() async {
    ...
    var uReponse  = await _apiM.submitGame(userId, catCoins, catexpPoints, _numOfCorrect.toString(), numOfQues.toString(), _subOrRan) ;
    ...
    if(uReponse is UserLogin) {
      pr.hide().then((isHidden) {
       ...
       String _perc = ((int.parse(_uLogin.correct)/int.parse(_uLogin.attempted))*(100)).toStringAsFixed(1) ;
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(color: Colors.white38.withOpacity(0.2), width: 3)
                        ),
                      ),

                      AnimatedContainer(
                        duration: _quesUpdated ? Duration(milliseconds: 100) : Duration(seconds: 10),
                        width: _animatedWidth,
                        height: cheight*0.06,
                        decoration: BoxDecoration(
                          gradient: LinearGradient(colors: [Color(0XFFb783ff), Color(0XFFffaebf)] ),
                          color: Colors.blue,
                          borderRadius: BorderRadius.all(Radius.circular(24)),
                            border: Border.all(color: Colors.white38.withOpacity(0.2), width: 3)
                        ),
                               ...
                               child: Container(
                                 ...
                                 child: Center(
                                   child: Row(
                                     ...
                                     _answerGiven && _selectedA ?  Padding(
                                         ...
                                         child: Container(
                                          ...
                                          /* decoration: BoxDecoration(
                                           ...
                                           child: _answerIsA ? Icon(Icons.check_circle, color: Colors.blueAccent) : Icon(Icons.remove_circle, color: Colors.red)
                                         ),
                                       ) :
                                     Padding(
                                       padding: const EdgeInsets.only(right: 8.0),
                               ...
                               child: Container(
                                 ...
                                 child: Row(
                                   ...
                                   children: <Widget>[
                                     ...
                                     _answerGiven && _selectedB ?   Padding(
                                       padding: const EdgeInsets.only(right: 8.0),
                                       child: Container(
                                           height: 20,
                                           width: 20,
                                           ...
                                           child: _answerIsB ? Icon(Icons.check_circle, color: Colors.blueAccent) : Icon(Icons.remove_circle, color: Colors.red)
                                       ),
                                     )
                                         : Padding(
                                       padding: const EdgeInsets.only(right: 8.0),
                               ...
                               child: Container(
                                 ...
                                 child: Row(
                                   ...
                                   children: <Widget>[
                                     ...
                                     _answerGiven && _selectedC ?   Padding(
                                       padding: const EdgeInsets.only(right: 8.0),
                                       child: Container(
                                           height: 20,
                                           width: 20,
                                           ...
                                           child: _answerIsC ? Icon(Icons.check_circle, color: Colors.blueAccent) : Icon(Icons.remove_circle, color: Colors.red)
                                       ),
                                     ) :
                                      Padding(
                                       padding: const EdgeInsets.only(right: 8.0),
                               ...
                               child: Container(
                                 ...
                                 child: Row(
                                   ...
                                   children: <Widget>[
                                     ...
                                     _answerGiven && _selectedD ?  Padding(
                                       padding: const EdgeInsets.only(right: 8.0),
                                       child: Container(
                                           height: 20,
                                           width: 20,
                                           ...
                                           child: _answerIsD ? Icon(Icons.check_circle, color: Colors.blueAccent) : Icon(Icons.remove_circle, color: Colors.red)
                                       ),
                                     ) :
                                     Padding(
                                       padding: const EdgeInsets.only(right: 8.0),
