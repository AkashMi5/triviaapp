...
class _DashboardState extends State<Dashboard> {
  ...
  String mssg = "i) There are 2 modes to play the game: 1. Subject-wise 2. Random  \n \n"
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
            ...
            child: Column(
              ...
              children: <Widget>[
                Center(
                  child: Stack(
                    children: <Widget>[
                      Image.asset('user_avatar2.png', height: cheight*0.06, width: cheight*.06,),
                      /*Positioned(
                        right: -1,
                          bottom: 1,
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      InkWell(
                        ...
                        child: Column(
                          children: <Widget>[
                            Image.asset('coin3.png', height: cheight*0.05, width: cheight*0.05),
                            SizedBox(height: 10,),
                            Text(
                              _coins,
                              style: TextStyle(
                      ...
                      InkWell(
                        ...
                        child: Column(
                          children: <Widget>[
                            Image.asset('badge.png', height: cheight*0.05, width: cheight*0.05),
                            SizedBox(height: 10,),
                            Text(
                              _expPoints,
                              style: TextStyle(
                      ...
                      InkWell(
                        onTap: (){
                          Fluttertoast.showToast(
                              msg: "Percentage of questions you have answered correctly",
                              toastLength: Toast.LENGTH_SHORT,
                              gravity: ToastGravity.CENTER,
                              timeInSecForIosWeb: 1,
                              backgroundColor: Colors.blueGrey,
                        ...
                        child: Column(
                          children: <Widget>[
                            SizedBox(height: 10),
                            Image.asset('percentage.png', height: cheight*0.04, width: cheight*0.04),
                            SizedBox(height: 5),
                            Text(
                              _perc,
                              style: TextStyle(
          ...
          Container(
            ...
            child: Center(
              child: InkWell(
                ...
                child: Image.asset('menu.png', color: Colors.white70, height: 25, width: 25,),
              ),
            ),
          ),
          ...
          Container(
            margin: EdgeInsets.only(top: cheight*0.35, left: cwidth*0.07, right: cwidth*0.07),
            child: Column(
              children: <Widget>[
                Card(
                  elevation: 6.0,
                          ...
                          Center(
                            child: Column(
                              children: <Widget>[
                                ...
                                Padding(
                                  padding:  EdgeInsets.symmetric(horizontal: cwidth*0.04),
                                  child: Row(
                                ...
                                Padding(
                                  padding:  EdgeInsets.symmetric(horizontal: cwidth*0.16),
                                  child: Container(
                                    height: 5,
                                    width: cwidth*0.7,
                                    decoration: BoxDecoration(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      Expanded(
                                        flex: 1,
                                        child: Text("Played " + _sGamesNum + " games",
                                          style: TextStyle(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: <Widget>[
                                      Expanded(
                                        flex: 1,
                                        child: Text("Played " + _rGamesNum + " games",
                                          style: TextStyle(
                                              fontSize: cheight*0.022,
                                              color: Colors.white,
                                              fontFamily: 'PoppinsRegular'
