    ...
    return Scaffold(
       ...
       //   EllipticalWidget(),
          Elliptical2Widget(),
                      ...
                      child: Stack(
                          children: <Widget>[
                           Padding(
                             ...
                             child: _fileName.isEmpty ? Image.asset('user_avatar2.png', height: cheight*0.06, width: cheight*.06) :
                             Container(
                                 width: cheight*0.07,
                                 height: cheight*0.07,
                                 decoration: new BoxDecoration(
                                     ...
                                     image: new DecorationImage(
                                         fit: BoxFit.fill,
                                         image: NetworkImage(_imageBaseUrl + _fileName)
                                     )
                                 )
                             ),
                                        /* CircleAvatar(
                            ...
                            Positioned(
                              ...
                              child: InkWell(
                                ...
                                child: Icon(Icons.camera_enhance, color: Colors.white70,),
                              ),
                            )
                            ],
                          ),
            ...
            Container(
                margin: EdgeInsets.only(top: cheight*0.35, left: cwidth*0.1, right: cwidth*0.1),
                child: Column(
                     children: <Widget>[
                       Row(
                         ...
                         children: [
                           Expanded(
                               child: Image.asset('coin3.png', height: cheight*0.05, width: cheight*0.05),
                             flex: 1,
                           ),
                         ...
                         children: [
                           Expanded(
                             ...
                             child: Padding(
                               ...
                               child: Image.asset('badge.png', height: cheight*0.05, width: cheight*0.05),
                             ),
                           ),
                         ...
                         children: [
                           Expanded(
                             ...
                             child: Padding(
                               ...
                               child: Image.asset('percentage.png', height: cheight*0.04, width: cheight*0.04),
                             ),
                           ),
